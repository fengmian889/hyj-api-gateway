...
import (
	...
	"github.com/fengmian889/hyj-api-gateway/cmd/api-gateway/app/options"
	"github.com/fengmian889/hyj-api-gateway/pkg/version"
)
...
func NewFastGOCommand() *cobra.Command {
	...
	cmd.PersistentFlags().StringVarP(&configFile, "config", "c", filePath(), "Path to the calllog-apiserver configuration file.")
